...
export const NewsCard = ({ 
  ...
  return (
    <div className={cn("bg-white rounded-none overflow-hidden border border-gray-200 shadow-sm transition-all duration-200 relative", className)}>
      ...
      <Link to={href} className="absolute bottom-6 right-6 flex items-center justify-center w-10 h-10 bg-primary rounded-full text-white hover:bg-red-800 hover:scale-110 transition-all duration-200" aria-label={`Read ${title}`}>
