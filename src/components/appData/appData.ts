  ...
  export const faqs = [
    {
      ...
      a: "We're currently in the final stages of development and testing. We expect to launch the SCISA app in the next semester. Waitlist members will be notified first.",
    },
    {
      q: "Will the app be free?",
      a: "Yes! The SCISA app is a free service provided by the Science Students’ Association for all students in the College of Science.",
    },
    {
      q: "What devices will the app support?",
      a: "The SCISA app will be available on iOS, Android, and as a web application, ensuring you can access it from any device.",
    },
    {
